        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, defaultValue: "Ev"),
                    ...
                    BuildingNo = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoonType = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingMethod = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "standard"),
                    TrackingNumber = table.Column<string>(type: "text", nullable: true),
                    ShipFullName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false, defaultValue: ""),
                    ShipPhone = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: ""),
                    ShipCity = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false, defaultValue: ""),
                    ShipDistrict = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false, defaultValue: ""),
                    ShipNeighborhood = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false, defaultValue: ""),
                    ShipLine = table.Column<string>(type: "character varying(240)", maxLength: 240, nullable: false, defaultValue: ""),
                    ShipPostalCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false, defaultValue: ""),
                    ShipNotes = table.Column<string>(type: "text", nullable: true),
                    ReturnStatus = table.Column<string>(type: "text", nullable: false, defaultValue: "None"),
                    ReturnCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    ReturnRequestDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    ReturnItemsJson = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    ReturnApprovedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ReturnAdminNotes = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ReturnAddress = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ReturnShippingInfo = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ReturnTrackingNumber = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ReturnShippedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ReturnReceivedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ReturnInspectedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuitableForSkin = table.Column<int>(type: "integer", nullable: false),
                    Finish = table.Column<int>(type: "integer", nullable: true),
                    Coverage = table.Column<int>(type: "integer", nullable: true),
                    Longwear = table.Column<bool>(type: "boolean", nullable: false),
                    Waterproof = table.Column<bool>(type: "boolean", nullable: false),
                    PhotoFriendly = table.Column<bool>(type: "boolean", nullable: false),
                    HasSpf = table.Column<bool>(type: "boolean", nullable: false),
                    FragranceFree = table.Column<bool>(type: "boolean", nullable: false),
                    NonComedogenic = table.Column<bool>(type: "boolean", nullable: false),
                    ShadeFamily = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShadeCode = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                    ShadeFamily = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    HexColor = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: true),
                    SwatchImageUrl = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ImageUrl = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Price = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    DiscountPercent = table.Column<decimal>(type: "numeric(5,2)", nullable: true),
                    StockQuantity = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
