...
const LunaraDiscountPopup = () => {
    ...
    // Mythological moon phases with diverse discounts
    const moonPhases = [
        {
            id: 1,
            name: 'Crescent Moon',
        ...
        },
        {
            ...
            image: 'https://images.unsplash.com/photo-1509773896068-7fd415d91e2e?w=400&h=400&fit=crop',
        ...
        },
        {
            ...
            image: 'https://images.unsplash.com/photo-1517090504586-fde19ea6066f?w=400&h=400&fit=crop',
        ...
        },
        {
            ...
            image: 'https://images.unsplash.com/photo-1473892635345-9414f45c6ae0?w=400&h=400&fit=crop',
        ...
        },
        {
            ...
            image: 'https://images.unsplash.com/photo-1494253109108-2e30c049369b?w=400&h=400&fit=crop',
        ...
        },
        {
            ...
            image: 'https://images.unsplash.com/photo-1495344517868-8ebaf0a2044a?w=400&h=400&fit=crop',
    ...
    const handleMoonClick = (moonId) => {
        ...
        const randomDiscount = moonPhases[Math.floor(Math.random() * moonPhases.length)];
    ...
    const handleClaim = () => {
        if (discount) {
            localStorage.setItem('lunaraDiscount', JSON.stringify(discount));
            alert(`🌙 Lunara ${discount.value}% Moonlight discount added to your cart!\n✨ Valid for ${discount.condition}`);
        }
        handleClose();
    };
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-b from-indigo-950/95 via-purple-950/95 to-indigo-950/95 backdrop-blur-sm animate-fadeIn">
            ...
            <div className="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 rounded-3xl shadow-2xl max-w-2xl w-full mx-4 overflow-hidden border border-yellow-500/30">
                ...
                <div className="absolute top-12 right-12 text-amber-300 animate-float" style={{ animationDelay: '0.5s' }}>
                    <Star size={12} fill="currentColor" />
                </div>
                <div className="absolute bottom-16 left-12 text-yellow-400 animate-float" style={{ animationDelay: '1s' }}>
                ...
                <div className="p-8 pt-12 relative z-10">
                    ...
                    <div className="text-center mb-8">
                        <div className="mb-3 flex items-center justify-center gap-2">
                            ...
                            <Sparkles size={28} className="text-yellow-300 animate-pulse" style={{ animationDelay: '0.3s' }} />
                        </div>
                        <h3 className="text-2xl font-semibold text-white mb-2">
                            Moonlight Discount ✨
                        </h3>
                        <p className="text-purple-200/80 text-sm">
                            {step === 'initial' && 'Choose a mythological moon and reveal your celestial discount'}
                                ...
                                <button
                                    ...
                                    className={`relative aspect-square rounded-2xl transition-all duration-500 transform overflow-hidden group ${
                                        selectedMoon === moon.id
                                            ...
                                            : 'hover:scale-105'
                                    } ${isAnimating && selectedMoon !== moon.id ? 'opacity-30 scale-90' : ''}`}
                                    style={{
                                        boxShadow: selectedMoon === moon.id
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        style={{
                                            ...
                                            animation: selectedMoon === moon.id ? 'shine 2s infinite' : 'none'
                                        }}
                                    />
                    ...
                    {step === 'revealed' && discount && (
                        <div className="mb-6 animate-scaleIn">
                            <div
                                ...
                                style={{
                                    background: 'radial-gradient(circle at 50% 0%, rgba(234, 179, 8, 0.3) 0%, rgba(30, 27, 75, 0.9) 100%)',
                            ...
                            >
                                ...
                                <div className="text-yellow-200 text-2xl font-medium mb-3">{discount.name}</div>
                    ...
                    {step === 'revealed' ? (
                        <button
                            ...
                            style={{
                                background: 'linear-gradient(135deg, rgba(250, 204, 21, 0.9) 0%, rgba(251, 191, 36, 0.9) 100%)',
                            }}
                        >
