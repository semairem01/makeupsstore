    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post(`${API_ENDPOINTS.AUTH}/login`, {
                ...
                rememberMe, // backend kullanıyorsa
            });
            ...
            <div className="auth-left">
                <div className="auth-content">
                    ...
                    <div className="auth-header">
                        ...
                        <p className="auth-subtitle">Sign in to continue your beauty journey</p>
                    </div>
                        ...
                        <div className="input-group">
                            ...
                            <div className="input-wrapper">
                                ...
                                <input
                                    ...
                                    required
                                    autoComplete="email"   /* istersen "username" da kullanabilirsin */
                                />
                            </div>
                        </div>
                ...
                <div className="auth-hero">
                    ...
                    <div className="hero-content">
                        ...
                        <p className="hero-text">
                            Join thousands of beauty enthusiasts and explore our curated collection
                            of premium makeup and skincare products.
                        </p>
