...
const API_BASE_URL = (process.env.REACT_APP_API_URL || "http://localhost:5011").replace(/\/$/, "");
...
export const API_ENDPOINTS = {
    ...
    ADMIN_PRODUCT_VARIANTS: (productId) => `${API_BASE_URL}/api/admin/products/${productId}/variants`,
    ...
    // ✅ bunlar da localhost’tan kurtuldu
